        ...
        <div class="container">
            <div class="row align-items-center text-center text-md-start g-4">
                <div class="col-md-4 text-center">
                    <img src="${basePath}img/logo.png" alt="Logo Colmeia Girassol" class="img-fluid" style="max-width: 220px; height: auto; filter: drop-shadow(0 5px 10px rgba(0,0,0,0.1));">
                </div>
                <div class="col-md-4 text-center">
